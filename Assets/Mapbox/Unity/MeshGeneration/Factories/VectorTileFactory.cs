namespace Mapbox.Unity.MeshGeneration.Factories
{
	...
	public class VectorTileFactory : AbstractTileFactory
	{
		...
		/// <summary>
		/// Set up sublayers using CustomVectorLayerVisualizers.
		/// </summary>
		protected override void OnInitialized()
		{
			...
			foreach (var sublayer in _properties.vectorSubLayers)
			{
				...
				LayerVisualizerBase visualizer = CreateInstance<CustomVectorLayerVisualizer>();
				((CustomVectorLayerVisualizer)visualizer).SetProperties(sublayer, _properties.performanceOptions);
